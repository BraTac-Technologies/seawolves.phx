defmodule Wolves.Accounts.Admin do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Wolves.Repo)
  ...
  """
  def valid_password?(%Wolves.Accounts.Admin{hashed_password: hashed_password}, password)
