defmodule WolvesWeb.AdminAuthTest do
  use WolvesWeb.ConnCase, async: true

  alias Wolves.Accounts
  alias WolvesWeb.AdminAuth
  import Wolves.AccountsFixtures

  @remember_me_cookie "_wolves_web_admin_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, WolvesWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_admin/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      WolvesWeb.Endpoint.subscribe(live_socket_id)
