defmodule WolvesWeb.EventControllerTest do
  use WolvesWeb.ConnCase

  import Wolves.EventsFixtures

  @create_attrs %{date: ~N[2022-08-16 06:26:00], result1: 42, result2: 42, rival: "some rival", status: "some status"}
  ...
  describe "update event" do
    ...
    test "redirects when data is valid", %{conn: conn, event: event} do
      ...
      assert html_response(conn, 200) =~ "some updated rival"
    end
